...
describe('asset-loading-via-js', function () {
    ...
    it('should overwrite webpack output path to point to a wrm-resource', () => {
        ...
        const expected = `__webpack_require__.p = AJS.Meta.get('context-path') + "/download/resources/com.atlassian.plugin.test:${assets.attributes.key}/";`;
        const injectedLine = bundleFile.match(/__webpack_require__\.p = AJS\.Meta.*/)[0];
